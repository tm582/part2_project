...
heatmap.2(lcpm[hitlist2[1:100],], trace = 'none', Colv=FALSE, col=hmcol, main = 'Heatmap of lcpm for Primary Tumour')
...
#This produces n.sv of  
#Error occured, run svaseq with decreasing n.sv value
svseq=svaseq(dat, mod, mod0,n.sv)
