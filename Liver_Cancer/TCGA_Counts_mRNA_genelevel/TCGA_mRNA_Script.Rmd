...
#median.primary=apply(mergevstMat[,176:],1,median)
#median.recurrent=apply(mergevstMat[,2:2],1,median)
#median.normal=apply(mergevstMat[,c(1:175, 28:32)], 1, median)
...
contr.matrix2=makeContrasts(conds_originPrimary_Tumor-conds_originNormal_TCGA, conds_originPrimary_Tumor-conds_originNormal_GTEX, conds_originRecurrent_Tumor - conds_originNormal_TCGA, conds_originRecurrent_Tumor-conds_originNormal_GTEX, levels = colnames(design))

quartz()
v2=voom(dge, design, plot = T)

vfit2=lmFit(v2, design)
