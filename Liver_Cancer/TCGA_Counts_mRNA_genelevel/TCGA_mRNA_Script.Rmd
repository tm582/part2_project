...
voompca=prcomp(t(v$E))
quartz()
plot(voompca$x, pch=c(21,24)[batch], bg=cond_colours[conds_origin], cex=1, title(main = 'PCA Plot'))
text(voompca$x,as.character(coldata$Batch),cex=0.3,pos=1)
text(voompca$x,as.character(colnames(v$E)),cex=0.3,pos = 3)
...
heatmap.2(assay(rlt)[rownames(rltres[1:100,]),],col=hmcol,trace="none",cexRow = 0.5,cexCol = 0.5)
...
abline(h=0)
stripchart(svseq$sv[,1] ~ dds$Sample_Type,vertical=TRUE,main="SV1")
abline(h=0)

stripchart(svseq$sv[,2] ~ dds$Batch,vertical=TRUE,main="SV2")
abline(h=0)
stripchart(svseq$sv[,2] ~ dds$Sample_Type,vertical=TRUE,main="SV2")
abline(h=0)

stripchart(svseq$sv[,3] ~ dds$Batch,vertical=TRUE,main="SV3")
abline(h=0)
stripchart(svseq$sv[,3] ~ dds$Sample_Type,vertical=TRUE,main="SV3")
abline(h=0)
...
quartz()
plot(svapca$x, main='PCA Variance Stabilised for Merged Data', pch=c(21,24)[batch], col='black', bg=cond_colours[conds], cex=1)
